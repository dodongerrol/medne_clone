...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.container.find('.calendar')
            ...
            .on('mousedown.daterangepicker', 'td', $.proxy(this.clickDateTD, this))
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var dateHtml = moment(this.locale.monthNames[calendar[1][1].month()], 'MMM').format('MMMM') + calendar[1][1].format(" YYYY");
        ...
        clickDateTD: function(e) {
            ...
            this.element.trigger('clickTD.daterangepicker', date);
        },
