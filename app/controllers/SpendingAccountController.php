...
class SpendingAccountController extends \BaseController {
	public function getMednefitsCreditsAccount( )
	{
		...
		$format = array(
			...
			'total_credits'         => DecimalHelper::formatDecimal($total_credits - $top_up_total_credits),
			'available_credits'     => DecimalHelper::formatDecimal(($total_credits - $utilised_credits['credits']) - $top_up_total_available_credits),
			'purchased_credits'     => DecimalHelper::formatDecimal($purchased_credits - $top_up_total_purchased_credits),
			'bonus_credits'         => DecimalHelper::formatDecimal($bonus_credits - $top_up_total_bonus_credits),
			'total_utilised_credits'  => DecimalHelper::formatDecimal($utilised_credits['credits']),
