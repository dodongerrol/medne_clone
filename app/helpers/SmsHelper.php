...
class SmsHelper
{
	...
	public static function formatWelcomeEmployeeMessage($data)
	{
		...
		return "Hi! Your company hsa enrolled you into Mednefits! Download the app here https://bridgeurl.com/mednefits-app and activate your account by creating password using this mobile number.";
	}
}
?>