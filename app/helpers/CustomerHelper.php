		...
		if($status['currency_type'] == "myr") {
			if($status['account_type'] == "lite_plan" &&  $status['medical_method'] == "pre_paid" && $status['wellness_method'] == "pre_paid" && $status['paid_status'] == true)	{
				...
				if($status['wellness_reimbursement'] == true) {
					return array(
						'status' => true,
						'employee'	=> 'https://mednefits.s3-ap-southeast-1.amazonaws.com/excel/v5/myr/enterprise/employees/Employee+R-Wellness.xlsx',
					...
					return array(
						'status' => true,
						'employee'	=> 'https://mednefits.s3-ap-southeast-1.amazonaws.com/excel/v5/myr/enterprise/employees/Employee-Wellness.xlsx',
				...
				return array(
					'status' => true,
					'employee'	=> 'https://mednefits.s3-ap-southeast-1.amazonaws.com/excel/v5/myr/enterprise/employees/Employee+NO-SA-R.xlsx',
			...
			if($status['account_type'] == "lite_plan" &&  $status['medical_method'] == "pre_paid" && $status['wellness_method'] == "pre_paid" && $status['paid_status'] == true)	{
				...
				if($status['wellness_reimbursement'] == true) {
					return array(
						'status' => true,
						'employee'	=> 'https://mednefits.s3-ap-southeast-1.amazonaws.com/excel/v4/enterprise/employees/Employee+R-Wellness.xlsx',
