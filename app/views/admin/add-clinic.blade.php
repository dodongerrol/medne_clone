...
<div class="row" style="margin-top: 20px;">
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="page-header">            
            <h1 style="font-size: 100% !important;"><span class="label label-default">Add Clinic</span></h1>
        </div>  
        ...
        {{ Form:: open(array('url' => 'admin/clinic/insert-clinic','files'=> true)) }}
            ...
            <div class="form-group @if ($errors->has('custom_title')) has-error @endif">
                ...
                <input type="text" id="custom_title" class="form-control" name="custom_title">
            ...
            <div class="form-group  @if ($errors->has('clinic_type')) has-error @endif">
                ...
                {{ Form::select('clinic_type', $clinicTypes, null, array('class' => 'form-control')) }}
