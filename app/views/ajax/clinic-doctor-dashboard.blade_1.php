<div class="mc-date-filter">
    ...
    <div class="page-number2 mc-fr margin-control-new no-width">
      <!--<div class="number mc-fl"><a href="#">1</a></div>
      <div class="number mc-fl"><a href="#">2</a></div>
      <div class="number mc-fl"><a href="#">3</a></div>
      <div class="number mc-fl"><a href="#">4</a></div>
      <div class="number mc-fl"><a href="#">5</a></div>
      <div class="number mc-fl"><a href="#">6</a></div>-->
...
<!--                                <div id="<?php echo $currentSlotDetail['appoint']['appointid'];?>" slottime="<?php echo $slotEstimatedTime;?>" bktype="1" class="day-event-lblue wd85 clinic-appoint-delete" data-reveal-id="clinicmyModal"> -->
       ...
       <div class="clear"></div>
<!--       {{ HTML::link('/auth/login', '<div class="btn-wrapper2"><div class=" mc-btn-booknow margine-control-ld">Pick Another Date</div></div>')}}-->
  ...
  <div class="mc-queue-container width50 mar-top3 mc-fl">
     ...
     <div class="profile-image mar-l">
        <img width="170" height="161" class="mar-l" alt="" src="{{ URL::asset('assets/images/img-patient.png') }}"> </div>
