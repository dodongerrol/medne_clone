...
<form id="form-clinic-booking" method="POST">        
    ...
    <div class="clear"></div>
    <!--<div id="load-popup-booking-ajax">-->
      ...
      <div class="clear"></div>
        ...
        <div class="field-container">
         ...
         <div id="popdate" class="field-type">
             <input id="booking-date" name="booking_date" class="input-date" type="text"  value="{{$loadarray['showcurrentdate']}}">
         </div><!--END OF FIELD TYPE-->
       </div><!--END OF FIELD CONTAINER-->
                        ...
                        if($loadarray['doctoravailability']['available_times']){
                            ...
                            if($activeAvailability == 1 && String_Helper_Web::GetActiveTime($i,$loadarray['currentdate'])==1){    
                                ...
                                //if($mystarttime == $i){    
                                    ...
                                    $mainEndTime = String_Helper_Web::FindEndTime($i,15);
                                }else{
...
<!--                  <script>
      ...
      <div class="field-container new-mart">
         	...
         	<div class="field-type">
                    <input id="nric" name="nric" class="" type="text" >
                <!--<input type="text">-->
                </div><!--END OF FIELD TYPE-->
        ...
        <div class="field-container-xsmall">
            ...
            <div class="field-type">
                <input id="code" name="code" type="text" value="" class="input-xsmall">
             </div><!--END OF FIELD TYPE-->
             <div class="field-name">
              <label>Code</label>
            </div><!--END OF FIELD NAME-->     
        ...
        <div class="field-container"> 
            <div id="new-appointment" clinictimeid="{{$loadarray['clinictimeid']}}" class="btn-update font-type-Montserrat">BOOK NOW</div>   
