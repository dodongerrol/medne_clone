...
<head>
	...
	<title>Health Benefits — Mednefits: Modern Employees Digital Benefits</title>
...
<body>
	<div class="body-container">
		...
		<section id="main-section">
			...
			<div class="content_section priority">
				<div class="col-md-12 no-padding xs-text-center">
					<button onclick="window.location.href='/'" class="btn btn-default btn-back text-underline" style="margin: 20px 0;">BACK</button>
				</div>

				<div class="col-md-12 text-center">
					<h1 class="color-blue">Your Wellbeing. Our Priority</h1>
					<h2 class="color-blue text-center font-light">Putting employees at the forefront of their health and wellness journey.</h2>	
					<p>The freedom to choose from a vast array of health and wellness services islandwide.</p>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 icons text-center">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 text-center">
					<button onclick="window.location.href='/get-mednefits'" class="btn btn-info text-underline" style="margin-bottom: 20px;">START YOUR JOURNEY</button>
				</div>
