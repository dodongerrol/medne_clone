...
<body>
		...
		<section id="main-section">
			...
			<div id="second-section" class="content_section text-center how-it-works">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h1 class="color-blue">How it Works</h1>
					<h2 class="color-blue">We provide corporate insurance that gives bonus health and wellness benefits for your employees to enjoy.</h2>
					<p>Our unique employees benefits services were designed for modern companies like yours.</p>
				</div>

				<div class="col-xs-12 col-sm-4 col-md-4 text-center">
					<img src="{{ URL::asset('assets/new_landing/images/landing/how1.jpg') }}" class="img-responsive margin-center">
					<button onclick="window.location.href='/buy-insurance'" class="btn btn-primary text-underline">LEARN MORE</button>
				</div>

				<div class="col-xs-12 col-sm-4 col-md-4 text-center">
					<img src="{{ URL::asset('assets/new_landing/images/landing/how2.jpg') }}" class="img-responsive margin-center">
					<button onclick="window.location.href='/bonus-credits'" class="btn btn-primary text-underline">LEARN MORE</button>
				</div>

				<div class="col-xs-12 col-sm-4 col-md-4 text-center">
					<img src="{{ URL::asset('assets/new_landing/images/landing/how3.jpg') }}" class="img-responsive margin-center">
					<button onclick="window.location.href='/health-benefits'" class="btn btn-primary text-underline">LEARN MORE</button>
				</div>
			</div>
		</section>
	...
	<script type="text/javascript">
		$('.para-1').parallax({
			imageSrc: 'assets/new_landing/images/landing/image-1.jpg',
		});

		$('.para-2').parallax({
			imageSrc: 'assets/new_landing/images/landing/image-2.jpg',
		});
