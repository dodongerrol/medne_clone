  ...
  <body style="font-family:'Arial';box-sizing: border-box;margin: 0;padding: 0;display: block;">
    ...
    <div id="main-template-wrapper" style="width: 100%;height: 100%;position: relative;overflow: hidden;">
      ...
      <div style="position:relative;min-height: 500px;background: #fff;min-height: 500px;padding: 50px">
        <img src="http://staging.medicloud.sg/e-template-img/welcome-to-mednefits-(corporate-account).jpg" style="width: 100%;">

        <p style="font-weight: 700;font-size: 20px;margin: 30px 0;">Your Care Plan Status</p>
        
        <p>Hi {{ $emailName }},</p>

        <p>Your Care Plan for <b>{{ $company }}</b> is going to expire this coming <b>{{ $date }}</b>. Please renew your Care Plan before the expiration date. You still have a month to renew.</p>
