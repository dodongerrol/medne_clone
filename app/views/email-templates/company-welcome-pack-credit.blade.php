...
<div id="medi-emailtemplate-wrapper" style="width:90%; background-color: #CCC; margin-top:3%; margin-bottom:3%; margin-left:auto; margin-right:auto;  ">
  ...
  <div id="title-detail" style=" word-wrap:break-word;">Once again thank you for joining us. Our goal is to make health benefits simple, human and affordable. We are excited to embark the journey with you and your team, together we will achieve the vision of Healthy Employees = Healthy Business. 
    </div>
  </div>
  ...
  <div id="detail-container" style="padding-top: 20px;padding-bottom: 20px;background-color:#fff;">      
    <div id="title-detail" style=" font-size:14px; word-wrap:break-word; padding-bottom:10px;" >
      Your Next Step:
      <p></p>
      1. Enroll your team members into Mednefits Care before the plan start date by logging into Your Company Benefits
Dashboard.
      <br />
      <div style="width: 100%;padding: 20px;">
        <span style="font-weight: bold;text-decoration: underline;">Account Details</span>
        <br />
        <span><span style="font-weight: bold;">Weblink: </span><a href="">mednefits.com/company-benefits-dashboard</a></span>
        <br />
      ...
      2. Download your Mednefits Care <a href="{{$welcome_pack}}" style="color: #5e96c5!important">welcome pack</a>, inside you will find a breakdown of how everything works (a step by
step guide to using our product, the plan coverage, panel health partner list - our health partners increases everyday,
hence you may expect the increasing number of partners updated in this list).
      <br />
      3. You can find everything on <a href="{{$contract}}" style="color: #5e96c5!important">contract and finances here,</a> (your receipt, invoice, and certificate).
      <br />
      4. We understand you might need a Demo Mednefits Care account to test it before the plan start. Now you can start
touring our simple and friendly interface, or probably show it to your team before they get theirs. Note: Demo account will
not be valid for real usage and it will expire 1 day before your plan start date.
      <div style="width: 100%;padding: 20px;">
        <span style="font-weight: bold;text-decoration: underline;">Account Details for Mednefits App</span>
        <br />
        <span>Download Mednefits App in either on Apple App Store or Android PlayStore</span>
        <br />
        <span><span style="font-weight: bold;">Login ID: </span><a href="">mednefits@mednefits.com</a></span>
        <br />
