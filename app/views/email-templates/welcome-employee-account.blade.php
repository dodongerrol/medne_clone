...
<div id="medi-emailtemplate-wrapper" style="width:90%; background-color: #CCC; margin-top:3%; margin-bottom:3%; margin-left:auto; margin-right:auto;  ">
  ...
  <div id="medi-header-wrapper">
        ...
        <div id="header-line" style="height:10px; background-color:#72d0f6;">
            ...
            <div id="header-logo-container" style="background-color:#1868ad;">
                <img style="display:block; margin:0px; padding:0px" src="https://www.medicloud.sg/e-template-img/welcome-to-mednefits-(corporate-account).jpg" width="100%"    alt=""/> 
    </div>  
  </div>
  ...
  <div id="detail-container" style=" padding:20px 15px; background-color:#fff; " >
       ...
       <div id="title-name" style=" font-size:14px; font-family: 'Varela Round', sans-serif; padding-bottom:10px;"  >
            <b>WELCOME TO MEDNEFITS</b>
    </div>
 
             <div id="title-detail" style=" word-wrap:break-word;" >
              Hi {{$name}},<br>
              We are excited to have you on-board. Your company {{$company}} has enrolled you into the Mednefits health benefits program. Now you can enjoy corporate rate on health and wellness services all listed in our platform, this email serves as a confirmation that you are now successfully registered with us.
              <br><br>
              Your account login details for your Mednefits App
              <br />
              <b>Registered Email</b> :  <span style="color: black;">{{$email}}</span><br> 
              <b>Password</b> : {{$pw}}<br>
              <!-- Mednefits-Credit : ${{$credit}} -->
              <br><br>
              @if($start_date_status)
              <p>Your Care Plan Package will start on <b>{{$start_date}}</b></p>
              @endif
              <!-- Mednefits-Credit will act as an e-voucher for you to spend on any health and wellness services listed in our platform.   -->
              <p>YOUR NEXT STEP</p>
              <p></p>
              <p>
                1. See <a href="https://drive.google.com/open?id=0B5jNkJc1lOQDZjhpWmxwcDhMbWc" >How Mednefits Works</a>
                <br />
                2. Check out the <a href="https://docs.google.com/spreadsheets/d/1YtsLDjgdHu6bKkZWRGtBIdeyWhwPTnDdQGFrUsBOZ9g/pubhtml">list of our health partner</a>
                <br />
                3. <a href="https://drive.google.com/file/d/0B5jNkJc1lOQDVmNabzdUeGpBRTg/view">View your coverage</a>
              </p>
              <br>
