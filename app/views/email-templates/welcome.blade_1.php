...
<div style=" background-color:#188fc8; max-width:749px; min-width:320px; margin:0% auto; text-align:left;"><!--Email template container -->
  ...
  <div id="email_container" style="text-align:left; padding-left:10px;">
    <div id="detail" style="width:50%; padding-left:10%; padding-top:6.0%; float:left;">
      <div id="title" style=" font-size: 5.9vw; color:#ffffff;  font-family: Arial, sans-serif; font-weight:bold;">Hello!</div>
      <div id="breef" style=" font-size:.8em; color:#ffffff; font-family: Arial, sans-serif; line-height:1.7">Welcome! and Thank you for registering with us. <br /> 
Medicloud is built to make healthcare better.<br />  
Next time you wish to make an appointment with <br /> 
your doctor, use medicloud. <br /> <br /> 

Our booking and alerts keep you posted when<br />  
its your turn for the appointment, saving you quite
a lot of time from queues.<br /> <br /> 

Booking is as simple as 3 Steps <br />
<span style="color:#00354e;">1. Search and Find your Doctor</span><br />  
<span style="color:#00354e;">2. Pick a time or take a number </span> <br /> 
<span style="color:#00354e;">3. Confirm your Booking! </span> <br /> 
<br /> 
 </div>
  ...
  <div id="btn_find" style="clear:both; padding-top:10%; ackground-color:#C69; text-align:center;  margin-bottom:67px;">
    <div id="btn" style=" font-size:20px; padding-top:2%; padding-bottom:2%; background-color:#004d71; width:210px; text-align:center; margin:0% auto; -webkit-border-radius: 71px; -moz-border-radius: 71px; border-radius: 71px; color:#fff;"><?php echo $activeLink;?></div>
  </div>
