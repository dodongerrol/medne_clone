...
<div id="medi-emailtemplate-wrapper" style="width:90%; background-color: #CCC; margin-top:3%; margin-bottom:3%; margin-left:auto; margin-right:auto;  ">
  ...
  <div id="title-detail" style=" word-wrap:break-word;">Once again thank you for joining us. Our goal is to make health benefits simple, human and affordable. We are excited to
embark the journey with you and your team, together we will achieve the vision of Healthy Employees = Healthy
Business. 
    </div>
  </div>
  ...
  <div id="detail-container" style="padding-top: 20px;padding-bottom: 20px;background-color:#fff; " >      
    <div id="title-detail" style=" font-size:14px; word-wrap:break-word; padding-bottom:10px;" >
      Your Next Step:
      <p></p>
      1. Kindly please make your payment by cheque to us at least 5 working days before the plan start date. Download your invoice <a href="{{$invoice_link}}">here</a>, for payment information.
      <p></p>
      2. Enroll your team members into Mednefits Care before the plan start date by logging into Your Company Benefits
Dashboard.
      <br />
      ...
      3. Download your Mednefits Care welcome pack, inside you will find a breakdown of how everything works (a step by
