...
<div style=" background-color:#188fc8; max-width:749px; min-width:320px; margin:0% auto; text-align:left;"><!--Email template container -->
  ...
  <div id="email_container" style="text-align:left; padding-left:10px;">
    <div id="detail" style="width:50%; padding-left:10%; padding-top:6.0%; float:left;">
      <div id="title" style=" font-size: 5vw; color:#ffffff;  font-family: Arial, sans-serif; font-weight:bold;">Hello <?php echo $data->company_name;?>!</div>
      <div id="breef" style=" font-size:.8em; color:#ffffff; font-family: Arial, sans-serif; line-height:1.7">These are your credentials in Corporate Company. <br /> 
      <label>Email: </label><?php echo $data->email;?><br>
      <br />
      <label>Password: </label><?php echo $pass;?>
      <br />
      <label>First Name: </label><?php echo $data->first_name;?>
      <br />
      <label>Last Name: </label><?php echo $data->last_name;?>
      <br />
      <label>Company Name: </label><?php echo $data->company_name;?>
      <br />
      <label>Credits: $</label><?php echo $data->credit;?>
     <br /> 
     <br /> 

    </div>
    <div id="breef" style=" font-size:.8em; color:#ffffff; font-family: Arial, sans-serif; line-height:1.7">Please activate your account by clicking this link. This will activate your credits as well. <br /> 
    <a href="http://localhost/medicloud_v003/public/app/corporate/activate/{{ $user_id }}">http://localhost/medicloud_v003/public/app/corporate/activate/{{ $user_id }}</a>
    </div>
