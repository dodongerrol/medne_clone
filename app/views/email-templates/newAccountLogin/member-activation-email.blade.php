      ...
      <div style="position:relative;min-height: 500px;background: #fff;padding: 70px 60px 30px;">
        ...
        <div>
          ...
          <p style="margin: 0 0 25px 0; font-size: 15px;line-height: 18px;">
            Your company has enrolled you into the Mednefits health benefits program. Please click the following button to download Mednefits App and use this registered mobile number <span>+65 86787587</span> as your login id to create your password during account activation.
          </p>

          <div style="text-align: center; margin: 30px 0 50px;">
            <a href="{{$button}}" style="display:inline-block;text-decoration: none;background-color: #3192CF; border-radius: 4px; color: #fff; border: 0; width: 331px; font-size: 15px; padding: 8px 0; outline: none;">Download Mednefits</a>
          </div>
