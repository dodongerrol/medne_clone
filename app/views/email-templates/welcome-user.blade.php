...
<head>
<meta charset="utf-8">
<title>Mednifits-Confirmation</title>
       ...
       <div id="title-name" style=" font-size:15px; font-family: 'Varela Round', sans-serif; padding-bottom:10px;"  >
            <b>WELCOME TO MEDNEFITS</b>
             ...
             <div id="title-detail" style=" word-wrap:break-word;" >
              ...
              As you have recently booked an appointment with preferred health or wellness provider via Mednefits, this email serves as a confirmation that you are now sucessfully registerd with us.
              <br><br>
              Registerd Emaill :  {{$emailTo}}<br> 
              Password : {{$pw}}
              <br><br>
              Please click this link to activate and update your account:
              <a href="{{ $link }}"> {{ $link }} </a>
              <br><br>
              Now you can download Medicloud app to manage your appointments and account settings.
              <br><br>
