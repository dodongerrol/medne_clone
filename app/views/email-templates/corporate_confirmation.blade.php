...
<!--template wraper-->
<div id="medi-emailtemplate-wrapper" style="background-color: #CCC; margin-left:auto; margin-right:auto;  ">
       ...
       <div id="title-name" style=" font-size:15px; font-family: 'Varela Round', sans-serif; padding-bottom:10px;"  >
            <b>WELCOME TO MEDICLOUD</b>
             ...
             <div id="title-detail" style=" word-wrap:break-word;" >
              ...
              You successfully activated you account with company name {{ $result['company_name']}}
              <br><br>
              You have ${{ $result['credit'] }} by activating your account!
              <br><br>
