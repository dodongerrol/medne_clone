  ...
  <div id="detail-container" style=" padding:20px 15px; background-color:#fff; " >
       ...
       <div id="title-name" style=" font-size:15px; font-family: 'Varela Round', sans-serif; padding-bottom:10px;"  >
            Hello {{$emailName}},
             ...
             <div id="title-detail" style=" word-wrap:break-word;" >Thank you for using Mednefits, it was a pleasure serving you. Below are your appointment information for future reference:
            </div>
  </div>
