...
<div id="medi-emailtemplate-wrapper" style="width:90%; background-color: #CCC; margin-top:3%; margin-bottom:3%; margin-left:auto; margin-right:auto;  ">
  ...
  <div id="detail-container" style="padding-top: 20px;padding-bottom: 20px;background-color:#fff; " >
    ...
    <div id="title-detail" style=" word-wrap:break-word;">Your company <span style="text-decoration: underline;">Mednefits Pte Ltd</span> has enrolled you into the Mednefits health benefits program. A program that allows you
  to experience amazing health benefits, that covers up to 70% of your primary and preventive health care
    </div>
    <p> </p>
  ...
  <div id="detail-container" style="padding-bottom: 20px;background-color:#fff; " >      
    <div id="title-detail" style=" font-size:14px; word-wrap:break-word; padding-bottom:10px;" >
      ...
      <div style="width: 100%;">
          ...
          <br />
          1. See <a href="" style="color: #0C80BC!important;">How Mednefits Works</a>
          <br />
          2. <a href="" style="color: #0C80BC!important;">View your coverage</a>
          <br />
          3. <a href="" style="color: #0C80BC!important;">See which health partners is nearer to you </a> - our health partners increases everyday, hence you may expect the increasing number of partners updated in this list
      </div>
      <div id="title-detail" style=" font-size:14px; word-wrap:break-word; padding-bottom:10px;" >
