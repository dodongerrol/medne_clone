...
<div id="medi-emailtemplate-wrapper" style="width:90%; background-color: #CCC; margin-top:3%; margin-bottom:3%; margin-left:auto; margin-right:auto;  ">
  ...
  <div id="detail-container" style=" padding:20px 15px; background-color:#fff; " >
       ...
       <div id="title-name" style=" font-size:22px; font-family: 'Varela Round', sans-serif; padding-bottom:10px;"  >
            New Inquery
    </div>
 
             <div id="title-detail" style=" font-size:18px; font-family: 'Varela Round', sans-serif; padding-bottom:10px;word-wrap:break-word;" >
                 You have received a new inquery
            </div>
  </div>
  ...
  <div id="booking-detail" style=" padding:20px 15px; background-color:#f8f6f6; font-family: 'Varela Round', sans-serif; " >
    ...
    <div id="booking-fields" style="  border-top:1px solid #d9d9d9; " >
       <div id="fields-title" style=" width: 230px; float:left; padding:5px 0px; background-color:#f8f6f6; "><b>Name:</b></div>
      <div id="fields-result" style=" float:left; padding:5px 0px; background-color:#f8f6f6; ">{{$fname}} {{$lname}}</div>
      <div id="clear" style="clear:both;"></div>  
    </div>
    		

    <div id="booking-fields" style="  border-top:1px solid #d9d9d9; " >
       <div id="fields-title" style=" width: 230px; float:left; padding:5px 0px; background-color:#f8f6f6; "><b>Email:</b></div>
      <div id="fields-result" style=" float:left; padding:5px 0px; background-color:#f8f6f6; ">{{$email}}</div>
      <div id="clear" style="clear:both;"></div>  
    </div>
     ...
     <div id="booking-fields" style=" border-top:1px solid #d9d9d9; " >
       <div id="fields-title" style=" width: 230px; float:left; padding:5px 0px; background-color:#f8f6f6; "><b>Phone:</b></div>
      <div id="fields-result" style=" float:left; padding:5px 0px; background-color:#f8f6f6; ">{{$phone}}</div>
      <div id="clear" style="clear:both;"></div>  
    </div>
     ...
     <div id="booking-fields" style=" border-top:1px solid #d9d9d9; " >
       <div id="fields-title" style=" width: 230px; float:left; padding:5px 0px; background-color:#f8f6f6; "><b>Company:</b> 	</div>
      <div id="fields-result" style=" float:left; padding:5px 0px; background-color:#f8f6f6; ">{{$company}}</div>
      <div id="clear" style="clear:both;"></div>  
    </div>
    			
    </div>
     			
     <div id="detail-container" style=" padding:20px 15px; background-color:#fff; font-family: 'Varela Round', sans-serif; font-weight: 400;" >
      <h4><b>Message:</b></h4>
      <p>{{$messages}}</p>
 ...
 <div id="footer-contact" style="text-align:center; background-color:#fff; padding-top:50px; padding-bottom:0px;">
   ...
   <img src="https://www.medicloud.sg/e-template-img/mednefits logo v3 (blue-box) LARGE.png" width="39" height="25"  alt=""/>
   </div>
