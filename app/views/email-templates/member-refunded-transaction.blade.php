...
<html><head>
    ...
    <div id="main-template-wrapper" style="background-image: url('https://s3-ap-southeast-1.amazonaws.com/mednefits/e-template-img/email-pdf-logo2.png');background-size: 100%;">
      <div class="top-content">
        <div class="header-content">
          ...
          <p style="font-size: 22px;">
            Oops, your transaction has been declined
          </p>
