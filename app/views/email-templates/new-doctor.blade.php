...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" bgcolor="#f0f0f0" style="background-color: #f0f0f0;">
  <tbody><tr>
    <td align="center" style="background-image: url('https://www.medicloud.sg/e-template-img/Welcome-to-our-health-network-email-banner.jpg'); background-size: 100%; background-position: 50% 50%; background-repeat: no-repeat;" background="https://medicloud.sg/images/header_bg.jpg">
                  ...
                  <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="full">
                    ...
                    <tr>
                      <td width="100%" style="color: #4f4f4f; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 10px; font-weight: 400; vertical-align: top; font-size: 24px; text-align: left; padding-top: 3px; text-transform: uppercase; word-break: break-word;" class="fullCenter">
                        <span style="font-family:arial,helvetica,sans-serif;"><span style="font-size:48px;"><strong><span style="color:#FFF0F5;">&nbsp;<span style="font-size:48px;"></strong></span></span>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td width="100%" style="color: #959595; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; line-height: 22px; font-weight: 600; vertical-align: top; font-size: 13px; text-align: left; padding-top: 10px;" class="fullCenter">
                        <p><span style="font-family:arial,helvetica,sans-serif;"><span style="color:#FFF0F5;"><span style="font-size:18px;"></span></span></span></p></td>
                    </tr>
                  ...
                  <table width="600" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align: center;" class="fullCenter">
                    ...
                    <tr>
                      <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #9c9c9c; line-height: 24px; font-weight: 400;" class="fullCenter">
                        <p><span style="color:#666666;"><strong></strong></span><span style="color:#000000;"><strong><br></strong></span></p><p><br></p><p>We are delighted that you have come aboard
Medicloud in it’s journey of revolutionizing healthcare.
You are one step away from registering with us.<br><br>

Please click on the “Create Password” button<br>
below and complete your membership  <br></p>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                          <td style="text-align: cemter;">
                            <a href="<?php echo $createLink;?>" style="text-decoration: none;">
                                <img src="https://medicloud.sg/images/create.png" alt="" border="0">
                            </a>
                          </td>
                    </tr>
                  </tbody></table>
                  ...
                  <table width="600" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align: center;" class="fullCenter">
                    ...
                    <tr>
                          <td style="text-align: center;">
                            <a href="#" style="text-decoration: none;">
                                <img src="https://www.medicloud.sg/e-template-img/mednefits+logo+v3+(blue-box)+LARGE.png" alt="" border="0" style="width:40px;height:40px;">
                            </a>
                          </td>
                    </tr>
