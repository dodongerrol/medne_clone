       ...
       <div id="title-name" style=" font-size:15px; font-family: 'Varela Round', sans-serif; padding-bottom:10px;"  >
            <b>WELCOME TO MEDICLOUD</b>
             ...
             <div id="title-detail" style=" word-wrap:break-word;" >
              ...
              As you have recently booked an appointment with preferred health or wellness provider via Medicloud, this email serves as a confirmation that you are now sucessfully registerd with us.
              <br><br>
