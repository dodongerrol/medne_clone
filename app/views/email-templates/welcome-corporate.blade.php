       ...
       <div id="title-name" style=" font-size:14px; font-family: 'Varela Round', sans-serif; padding-bottom:10px;"  >
            <b>WELCOME TO MEDNEFITS</b>
             ...
             <div id="title-detail" style=" word-wrap:break-word;" >
              Hi {{$name}},<br>
              We are excited to have you on-board. As your company have recently joined Mednefits and have added you into the employee benefits account. Now you can enjoy corporate rate on health and wellness services all listed in our platform, this email serves as a confirmation that you are now successfully registered with us.
              <br><br>
              Registerd Emaill :  {{$emailTo}}<br> 
              Password : {{$pw}}<br>
              Mednefits-Credit : SGD<b>${{$credit}}</b>
              <br><br>
              Mednefits-Credit will act as an e-voucher for you to spend on any health and wellness services listed in our platform.  
              <br>
              Download our app today to access your Mednefits - health and wellness benefits on the go.
              <br><br>
              If you have any questions,feel free to contact us at <span style="color:#156aaf;"><a style="text-decoration:none;" href="mailto:happiness@mednefits.com">happiness@mednefits.com</a></span>, we are always happy to here from you!
            </div>
  </div>
