...
<body>
	<div class="container">
		<div class="col-md-6 col-md-offset-3 text-center" style="margin-top: 100px;">
			<img src="https://s3-ap-southeast-1.amazonaws.com/mednefits/imageslogo.png" class="img-responsive">
			<div class="list-group">
			  <a href="/pdf/How Mednefits Works.pdf" class="list-group-item active">How Mednefits Works</a>
			  <a href="/pdf/Mednefits-u2019s Health Partners & Benefits (corp).pdf" class="list-group-item active">Mednefits Health Partners & Benefits</a>
