...
<?php //echo '<pre>'; print_r($doctors); echo '</pre>'; ?>

<style>
    
@media(-webkit-min-device-pixel-ratio: 2), 
(min-resolution: 192dpi) {
 .queue-bar-gray { background-color: #f4f4f4; border-left: 1px solid #95d3f0; cursor: pointer !important; height: 60px; margin-left: 17% !important; margin-bottom: 10px; width: 460px; }   
...
/*.pic-con{ margin-left: -5% !important; }*/
...
<!--     <div id="ajax-clinic-doctor-slider">  Ajax load page start -->
    ...
    <div class="appointments mc-fl">
      ...
      <div class="profile-image pic-con">
...
<div class="event-display mar-top24">
  ...
  <div class="mc-queue-container width50 mar-top3 mc-fl">
     ...
     <div class="profile-image mar-l pic-con">
...
<!-- Booking confirm message start -->   
<div class="cd-popup" role="alert"> <!--popup -->
	<div class="cd-popup-container">
    <div class="logo"><img src="{{ URL::asset('assets/images/mc-logo-center2.png') }}" width="137" height="43"  alt=""/></div>
...
<!-- Booking confirm message End -->  

  
  <div class="clear"></div>
  
  
{{ HTML::script('assets/js/datepickr.js') }}
