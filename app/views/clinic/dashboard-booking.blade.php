...
{{ HTML::style('assets/css/datepicker-nostyle.css') }}       
<style>
...
font-family: 'Montserrat', sans-serif;
   ...
   <div class="clear"></div>
    ...
    <div id="AJAX-Clinic-Booking-Detail-Page"> <!-- start AJAX detail page -->
...
<script type="text/javascript">	
    //$(function() {
    //$( "#DashboardBookingDatePicker" ).datepicker({dateFormat: 'DD, d MM, yy',});
    //$( "#DashboardBookingDatePicker" ).datepicker({dateFormat:"yy/mm/dd"}).datepicker("setDate",new Date(2015,6,27));
  //});	
