        ...
        <tr>
          <td colspan="2" style="padding-left: 40px;padding-bottom: 30px;font-size: 12px;">
            <div style="width: 150px;display: inline-block;vertical-align: middle;height: 80px;text-align: center;">
              <p style="margin: 0;max-height: 48px;height: 48px;background: #2E4057;border-radius: 5px 5px 0px 0px;color: #fff;padding: 0px 6px;line-height: 20px;display: inline-block;width: 100%;box-sizing: border-box;">
