      ...
      .notes .stamp{
    	...
    	<div class="bill-to">
	    	...
	    	<div class="item right-wrapper" >
    			...
    			<p><label>Payment Due: </label> {{ $payment_due }}</p>
        ...
        <!-- <tr class="tbody">
          <td style="text-align: left !important;padding-left: 30px;">
          	...
          	<p>Health Specialist: Dec 31 2019 (same as OMC000015)</p>
          	<p>TCM: 100% consultation covered, employees only need to pay medicine and treatment.</p>
          	<p>Wellness: Up to 40% off wellness services</p>
          </td>
          <td><b>1</b></td>
          <td><b>S$ 0.00</b></td>
          <td><b>S$ 0.00</b></td>
        ...
        <tr class="tbody">
          <td style="text-align: left !important;padding-left: 30px;">
          	<p><b>Add Employee - Standalone Mednefits Care (Corporate)</b></p>
          	<p>No. of employees: {{ $number_employess }}</p>
          	<p>Next Billing Date: {{ $next_billing }} (same as {{ $same_as_invoice }})</p>
