...
<html><head>
    ...
    <div class="receipt-content">
      <div class="header">
        <div style="padding-top:20px;width: 100%;height: 80px;display: block;">
        ...
        <p style="font-size: 14px;">Invoice #{{$statement_number}}</p>
        <p style="font-size: 14px;color: #cbcfd1;">for {{$company}}</p>
        <p style="font-size: 14px;color: #cbcfd1;">paid on {{$paid_date}}</p>
      ...
      <div class="body">
        ...
        <p style="margin-bottom: 10px;">Here's your spending receipt for Invoice #{{$statement_number}}, for ${{$paid_amount}} SGD.</p>
      ...
      <div class="amount">
        <p style="color: #464d52;"><b>Payment Amount: ${{$paid_amount}} SGD</b></p>
        @if($payment_remarks)
          @if($payment_remarks != 'NULL' || $payment_remarks != null)
          <h5>Note: {{ $payment_remarks }}</h5>
          @endif
        @endif
      </div>  

<!--       <div class="method">
        <p style="color: #464d52;"><b>Payment Method:</b></p>
      </div>   -->

      <div style="width: 100%;text-align: center;height: 150px;padding-top:80px;display: block;">
