...
<html>
  ...
  <body style="font-family:'Arial';box-sizing: border-box;margin: 0;padding: 0;display: block;">
    ...
    <div id="main-template-wrapper" style="width: 100%;height: 100%;position: relative;overflow: hidden;">
      ...
      <div style="position:relative;background: #fff;min-height: 450px;padding: 50px">
        ...
        <p style="font-size: 25px;color: #0392cf;font-weight: 700;margin-top: 40px;">Company Benefits Spending Account</p>

        <p style="text-decoration: underline;font-weight: 700;color: #000;font-size: 18px;">Receipt for 01 August - 31 August 2019</p>

        <p>Your payment has just arrived at our finance desk. We appreciate your prompt response, even on your exciting busy day. You may retrieve and download your Mednefits Care Certificate and Receipt here. Alternatively you can always view it at: <a style="color: #333" href="https://medicloud.sg/company-benefits-dashboard#/account-and-billing/transactions">https://medicloud.sg/company-benefits-dashboard#/account-and-billing/transactions</a></p>

        <a href="" style="margin: 15px 0 5px 0;padding: 12px 0px;border: none;border-radius: 4px;background: #3b84f1;color: #FFF;display: inline-block;font-size: 12px;text-decoration: none;width: 175px;text-align: center;">DOWNLOAD RECEIPT</a>
