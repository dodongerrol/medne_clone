...
.input-d {
    ...
    background-image: url("http://medicloud.sg/medicloud_web/public/assets/images/date-arrow.png");
...
<!--<div id="node-test">Click Me</div>-->
<div id="doctor-booking-ajax"> 
...
<!--            <input id="datepicker" class="input-d " type="text" >-->
     ...
     <div class="mc-calendar-option"> 
      ...
      <div id="doctor-checkout" class="select cursor">Checkout</div>
...
<div id="myModal" class="reveal-modal"> <!-- Start Booking page -->
    ...
    <div class="mc-doctor-profile-container"><!--DOCTOR PROFILE CONTAINER-->
     ...
     <div id="queue-slot" class="queue-counter2">
        ...
        <div id="queue-no" class="queue-number book-type-q d-margine-controller">
            <?php if($firstDoctorSlot['clinicsession']==1 || $firstDoctorSlot['clinicsession']==3){ echo count($firstDoctor['queue-booking'])+1; }?>
        </div>
        <div id="slot-time" class="queue-number4 book-type-a d-margine-controller"><?php echo $newslottime12; ?></div>
