  ...
  <!-- tabs -->
    ...
    <div class="tabbable detail-tab" style="padding-left: 30px; padding-top: 10px;">
      ...
      <div class="row" style="border-bottom: 1px solid #ddd;">
        <ul class="nav nav-tabs">
         <li class="active tab-border"><a id="clinic-hours-tab" href="#clinic-hours-main" data-toggle="tab"><b>BUSINESS-HOURS</b></a></li>
    ...
    <div class="tab-content row">
            <div class="tab-pane active" id="clinic-hours-main"></div>
