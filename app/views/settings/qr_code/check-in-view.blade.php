	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3 text-center inner-container" style="margin-top: 100px;-webkit-transition: margin-top 0.5s;transition: margin-top 0.5s;">
			...
			<div class="list-group">
			  ...
			  <a href="javascript:void(0)" target="_blank" class="list-group-item active" id="check_in_container">
			  	<button class="btn btn-lg btn-block btn-info" id="check_in">
			  		Check-In
			  		<span id="check_in_loader" style="display: none;"><img src="{{ URL::asset('images/loading_apple.gif') }}" style="width: 20px;"></span>
			  	</button>
			  </a>
			</div>
			<div class="list-group" id="payment_container" style="display: none;">
